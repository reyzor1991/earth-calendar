...
declare global {
    ...
    class Hooks {
        ...
        static on(event: string, callback: (message: ChatMessage, html: HTMLElement) => void): number;
    ...
    class FoundryUtils {
        parseHTML(value: string): HTMLElement;
